...
Cadastrando uma reserva
    ...
    ${data}=  Create Dictionary  firstname=matheus  lastname=santana  totalprice=222  depositpaid=True  bookingdates=${bookingdates}  additionalneeds=Breakfast
    Log  ${data}
    ...
    Should Be Equal As Strings    ${booking_info['firstname']}    matheus
    Should Be Equal As Strings    ${booking_info['lastname']}     santana
